...
describe('Composite test - object API', function() {
  var context = {};
  context.a = '1';
  context.b = '2';
  context.c = '3';
  ...
  it('should do "all" true correctly with previous values', function() {
    ruleset()
      .add({ path: 'a', comparator: 'eq', value: '1' })
      .add({ path: 'b', comparator: 'eq', value: '2' })
      .add({ path: 'c', comparator: 'eq', value: '3' })
      .add({ path: 'd', comparator: 'onChange' })
      .test({ nextValue: context, previousValue: { d: '' } })
      .should.equal(true);
  });
